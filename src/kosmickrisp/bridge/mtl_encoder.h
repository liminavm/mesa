 ...
 *
 * Also what lets a counter-sampling encoder carry real work: Metal elides a
 * blit encoder that encodes nothing, and an elided encoder never takes its
 * counter sample. See kk_encoder_write_timestamp. */
